...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(Exception ex, HttpServletRequest request) {
        log.error("AccessDeniedException/JwtException: ", ex);
    ...
    public ResponseEntity<ErrorResponse> handleStatusException(ResponseStatusException ex, HttpServletRequest request) {
        ...
        return buildResponse(ex.getStatusCode().value(), ex.getMessage(), ex.getReason(), request.getRequestURI());
    }
    ...
    private ResponseEntity<ErrorResponse> buildResponse(int status, String error, String message, String path) {
        ...
        ErrorResponse resp = new ErrorResponse(1, status, message != null ? message : error, traceId, path, timestamp);
